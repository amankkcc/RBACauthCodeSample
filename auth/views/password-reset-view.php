                    ...
                    <div class="col-md-12 col-sm-8 p-t-25">
                        <div class="signup_text">
                            ...
                            <div class="col-md-5 padding5  margintop20">
                                ...
                                <div class="well">
                             	<form id="loginForm" method="POST" action="<?php echo base_url(); ?>auth/enter_email" novalidate="novalidate">
                                    ...
                                    <button type="submit" class="btn btn-success btn-block">Get password reset link</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="text-success modal-title">Congratulation !</h3>
      </div>
